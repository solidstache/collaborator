...
export class Project {
	constructor(projectName, userName, description, progress, members, likes) {
...
export const sampleProjects = [
	new Project("MyFirstProject", "User1", "This is sample project 1", "Design Phase", [sampleUser1],5),
