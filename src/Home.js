...
const HomeSegmentIntro = () => (
    <Segment basic>
    	Collaborator is a web application that allows users to connect and work on projects together.

Often, someone has a good idea, but lacks key knowledge to start the project or to move past a specific hurdle. Collaborators role is to give these people a way to advertise what they are looking for in a partner or even just a contributor.
...
export default HomeSegmentIntro;
